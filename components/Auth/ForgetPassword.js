  ...
  return (
    <div className="flex flex-col space-y-4 border shadow-xl rounded-2xl p-3 px-5 w-4/5 md:w-1/3 mt-10">
      {uiState === "enterEmail" && (
        <>
          <div className="">
            <span className="text-1xl text-blue-900 font-semibold capitalize">
              Enter your registered email
            </span>
          </div>
          <form
            className="space-y-3 w-3/4 mx-auto"
            onSubmit={() => setUiState("forgetPassword")}
          >
        ...
        <>
          <div className="">
            <span className="text-lg text-blue-900 font-semibold">
              {" "}
              Enter the otp sent in your registed email and set the new
              password.
            </span>
          </div>
