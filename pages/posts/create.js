...
const Create = () => {
  ...
  return (
    <main className="md:w-3/4 flex-col justify-center items-center h-full mx-auto border p-6 my-4 md:mt-10 shadow-md rounded-md">
      ...
      <form className="flex flex-col w-full md:w-2/3 justify-center items-center mx-auto space-y-5" onSubmit={(e)=>post(e)} >
        <div className="flex items-center w-full">
          <InputOutline placeholder="Title" />
        </div>
        <div className="flex items-center w-full">
          <Textarea
            color="orange"
        ...
        <div className="flex items-center w-full">
          <InputOutline placeholder="Source" />
        </div>
        ...
        <div className="">
        <label htmlFor="imageUrl" className="text-gray-600">Image</label>
          <input
            type="file"
